...
void Desenha(void)
{
	...
	// de fundo definida previafmente
...
void Inicializa (void)
{
	...
	glClearColor(0.18f, 0.18f,0.5f, 1.0f);
	...
	//altera posição de rotação inicial
	rotX = 0;
	rotY = 270;
	...
	// Carrega o objeto 3D
	objeto = CarregaObjeto("AmerWarship.obj",true);
	objeto2 = CarregaObjeto("horse.obj",true);
